...
#define HCColorRGBA(r, g, b, a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:a]
...
@interface HCChart : UIView

@property (nonatomic , assign) CGFloat  margit;// 坐标轴与画布间距
@property (nonatomic , assign) CGFloat xValueMargit;// x轴每一个值的间隔数
@property (nonatomic , assign) CGFloat yValueMargit;// y轴每一个值的间隔数
